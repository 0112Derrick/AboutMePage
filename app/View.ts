...
enum RockPaperScissors {
  ...
  paper = "Paper",
  scissor = "Scissor",
  rockIMG = '<img class="charmander" id="charmander" src="../images/charmander_happy.webp" alt="Charmander" width="100" height="100" style ="border-radius:30% ">',
  paperIMG = '<img class="squirtle" id="squirtle" src="../images/squirtle-happily-smiling.gif" alt="Squirtle" width="100" height="100" style ="border-radius:30% ">',
  scissorIMG = '<img class="bulbasaur" id="bulbasaur" src="../images/bulbasaur_smile.gif" alt="Bulbasaur" width="100" height="100" style ="border-radius:30% ">',


  rockIMG2 = '<img class="charmander" id="charmander_atk" src="../images/charmander-big-flame-thrower.gif" alt="Charmander" width="100" height="100" style="border-radius:30%">',
  paperIMG2 = '<img class="squirtle" id="squirtle_atk" src="../images/pokemon-squirtle-hydro-pump.gif" alt="Squirtle" width="100" height="100" style ="border-radius:30% ">',
  scissorIMG2 = '<img class="bulbasaur" id="bulbasaur_atk" src="../images/pokemon-bulbasaur-atk.gif" alt="Bulbasaur" width="100" height="100" style ="border-radius:30% ">',


  paperIMG3 = '<img class="squirtle" src="../images/squirtle-bites-charmander-squirtle-bite.gif" alt="Squirtle" width="100" height="100" style ="border-radius:30% ">',
  scissorIMG3 = '<img class="bulbasaur" src="../images/bulbasaur-squitle.gif" alt="Bulbasaur" width="100" height="100" style ="border-radius:30%">',
}
...
export class View {
  DOM = [];
  slideShowIndex = 1;
  inputBox: HTMLElement = document.createElement('div');

  bg_color_1: string = 'rgba(136, 223, 255, 0.9)';
  bg_color_2: string = 'rgba(255, 230, 105, 0.8)';
  pg_color_1: string;
  pg_color_2: string;
  ...
  async chooseAssignment() {
    ...
    //handle event if user clicks submit button
    this.DOM[$HTML_IDS_INDEX.USER_INPUT_SUBMIT_BTN_MODAL].addEventListener('click', () => {
      this.processInput();
    });

    //handle event if user clicks enter key
  ...
  processInput() {
    ...
    if (assignmentNumb == 1) {
      ...
      let playerName: string = prompt("Hello Trainer, What's your name?");
      playerName ? playerName : playerName = 'Player';

      let playerGender: string = prompt("What's your gender? " + playerName);
  ...
  assignment4(playerChoice: RockPaperScissors, battlebox: HTMLElement, playerName?: string, playerGender?: string) {
    ...
    //creating ai element card to represent the ai pkmn img + ai name
    opponentCard.getCard().insertAdjacentHTML('beforebegin', `<div id="ai"></div>`);
    let ai = document.getElementById('ai');


    //creating player element card to represent the player pkmn img + player name
    trainerCard.getCard().insertAdjacentHTML('afterend', `<div id="player"></div>`);
    let player = document.getElementById('player');

    //styling the container holding the player/ai cards for proper positioning
    battlebox.style.gap = "20px";
    battlebox.style.justifyContent = "center";
    battlebox.style.alignItems = "center";

    //styling the battle images container for positioning
    ...
    //creating a results container to tell the user if they win or lose
    ...
    /**
     * Game logic
     * if player == rock && ai == paper || player == paper && ai == scissor ||
     * player == scissor && ai == rock then AI wins & player loses.
     * if player & ai chose the same values then its a draw 
     * otherwise player wins
     */
    if (playerChoice == RockPaperScissors.rock && aiChoice == RockPaperScissors.paper) {

      //Getting random value to determine between multiple battle animations and layouts
      ...
      (lostMusic as HTMLAudioElement).volume = 0.2;
      ...
      /*
      * Draw Scenario -
      * img represents an html element based on which ever pokemon was chosen. 
      * It is being used to reverse one of the atk images of the pokemon on its x axis to create a mirror image so that
      * when the images are facing towards each other the pokemon moves are attacking towards each other on screen.
      * 
      * the switch statement is used to break up logic based on which pokemon was chosen to battle.
      */
      ...
      (drawMusic as HTMLAudioElement).volume = 0.2;
      ...
      /**
       * Player win scenario - 
       * switch statement breaks up logic of what images should be displayed and their orientation on screen
       * random number is used to determine which image should be used in the battle box if theres 2 sets of appropriate images for the battle.
       */
      ...
      let victoryText: string = victoryPhrases[textOption];
      ...
      (victoryMusic as HTMLAudioElement).volume = 0.2;
    ...
    //creating a clear button and matching its styles to the webpage.
